...
{/* Update program:
  * Remove try catch
  * Test data using tryparse
  * add event associated with checkbox */
    public partial class frmCalculateGrade : Form
    {
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            if (!validGrade)
            {
                MessageBox.Show("Grade must be a whole number", "Data Error");
            ...
            else //data good, do the rest
            {
                ...
                switch (letter.ToLower())
                {
                    ...
                    case "d":
                        ...
                        break;
                    case "f":
                        MessageBox.Show("Sing up for tutorials!");
                        break;
                }// end switch
            }// end else
        }//end Calcualte event
        ...
        private void chkBonus_CheckedChanged(object sender, EventArgs e)
        {
            ...
            } //end if checked and label has date
        } //end evenet
    }
}
