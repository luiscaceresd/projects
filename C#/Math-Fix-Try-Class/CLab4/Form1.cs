...
namespace CLab4
{
    ...
    public partial class Form1 : Form
    {
        ...
        // not initialized (init in methods) - cannot refer to controls class-level
        ...
        {
            //initialize 2 ints - conversion required
            operand1= Convert.ToInt32(txtNum1.Text);
            operand2= Convert.ToInt32(txtNum2.Text);
         ...
         * Sent: none
         * Returned: none
         * This function clears controls and puts cursor at top */
        private void ResetForm()
        {
            //stub: MessageBox.Show("The Resetform function ran");
            //reset to blanks
            txtNum1.Text = "";
            txtNum2.Text = "";
            lblOperation.Text = "";
